	...
	<div id="comments">
		<h2 class="woocommerce-Reviews-title"><?php
			if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' && ( $count = $product->get_review_count() ) ) {
				...
				_e( 'Bình luận nhanh', 'woocommerce' );
			}
		?></h2>
			...
			<div id="review_form">
				<?php
					...
					$comment_form = array(
						...
						'comment_notes_after'  => '',
						'fields'               => array(
							'author' => '<div class="nm-wrap-comments">
											<div class="row">
												<div class="col-lg-12">
													<p class="comment-author">
														<label for="author">Nhập SĐT của bạn<span class="required">*</span></label>
														<input class="form-control" id="author" name="author" aria-required="true" type="text" value="' . esc_attr( $commenter['comment_author'] ) . '">
													</p>
												</div>
											</div>
										</div>',
							'comment_field' =>		'<div class="nm-wrap-comments">
							 <div class="row">
								<div class="col-lg-12">
									<p class="comment-author">
										<p class="comment-form-comment"><label for="comment">' . esc_html__( 'Your review', 'woocommerce' ) . '&nbsp;<span class="required">*</span></label>

	...
	<div id="slide-show-section" class="product-gallery_image">
		<?php
	        foreach ($attachment_ids as $key => $attachment_id) {
	        	$imgs = wp_get_attachment_image_src( $attachment_id, 'full', false );
	        	if ($imgs[0] != '') {
	        		$src = get_dns_thumbnail_url(array(400,350),$imgs[0]);
	        		$slider .= '<div class="items">
	        						<a alt="'.get_the_title().'" title="'.get_the_title().'"  class="prgallery" href="'.$imgs[0].'">
	        							<img src="'.$src.'" width="" height=""/>
	        							<div class="overlight"><i class="fa fa-search-plus" aria-hidden="true"></i></div>
	        						</a>
	        					</div>';
	        		$photos .= '<div class="items"><img src="'.$src.'" width="" height=""/></div>';
	        	}
	        }

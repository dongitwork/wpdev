...
class Rocket_Module_CTA extends ET_Builder_Module {
	function init() {
		$this->name       = esc_html__( 'Rocket Call To Action', 'et_builder' );
		$this->slug       = 'et_pb_rkt_ctadd';
		...
		$this->fields_defaults = array(
			...
			'use_background_color' => array( 'off' ),
		...
		$this->advanced_options = array(
			...
			'max_width' => array(
				'css' => array(
					...
					'module_alignment' => '%%order_class%%.et_pb_promo.et_pb_module .rkt_cta_content',
				),
			),
	...
	function shortcode_callback( $atts, $content = null, $function_name ) {
		...
		$output = sprintf(
			'<div%6$s class="rkt_cta-module et_pb_promo%4$s%7$s%8$s%9$s%11$s"%5$s>
				%12$s
				%10$s
				<div class="et_pb_promo_description">
					%1$s
					<div class="rkt_cta_content">
						%2$s
					</div>
				</div>
				%3$s
